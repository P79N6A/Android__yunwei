...
public class FragmentMonthStatistical extends BaseFragment {
...
//        MyLog.e("ssss", "herer is ob===>" + ob.toString());
        x.http().post(Tool.getParams(ob.toString(), getContext(), Constants.NDETAILS), new Callback.CommonCallback<String>() {
            @Override
