...
public class FragmentDayStatistical extends BaseFragment {
...
//        MyLog.e("ssss", "herer is ob===>" + ob.toString());
        x.http().post(Tool.getParams(ob.toString(), getContext(), Constants.DDETAILS), new Callback.CommonCallback<String>() {
            @Override
