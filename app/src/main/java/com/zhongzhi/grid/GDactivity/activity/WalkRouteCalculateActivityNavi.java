...
public class WalkRouteCalculateActivityNavi extends NaviBaseActivity {
    ...
    public void onInitNaviSuccess() {
        ...
        mAMapNavi.calculateWalkRoute(new NaviLatLng(startLat, startLng), new NaviLatLng(endLat, endLng));
